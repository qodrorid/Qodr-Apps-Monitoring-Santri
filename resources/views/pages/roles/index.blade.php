        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-md-2">
                            <select name="showitem" class="form-control" data-url="/roles">
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-group-button">
                                <input type="text" name="keyword" data-url="/roles" class="form-control" placeholder="Search ..." value="{{ request()->keyword }}">
                                <button type="button" class="input-group-addon btn btn-primary btn-paginate-search" data-url="/roles">
                    ...
                    <div class="float-right" id="pagination">
                        {{ $roles->links('components.pagination.ajax') }}
                    </div>
                </div>
            </div>
        </div>
