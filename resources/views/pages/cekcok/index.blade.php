                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <select name="showitem" class="form-control" data-url="/cekcok">
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-group-button">
                                <input type="text" name="keyword" data-url="/cekcok" class="form-control" placeholder="Search ..." value="{{ request()->keyword }}">
                                <button type="button" class="input-group-addon btn btn-primary btn-paginate-search" data-url="/cekcok">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#form-cekcok">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-list">
                            ...
                            <tbody id="listitem">
                                @php($no = $cekcok->perPage() * $cekcok->currentPage() - $cekcok->perPage() + 1)
                                @foreach ($cekcok as $item)    
                                <tr>
                    ...
                    <div class="float-right" id="pagination">
                        {{ $cekcok->links('components.pagination.ajax') }}
                    </div>
                </div>
            </div>
        </div>
...
@include('pages.cekcok.form')
@endsection

@section('javascript')
{{ HTML::script('js/pages/cekcok.js') }}
@endsection