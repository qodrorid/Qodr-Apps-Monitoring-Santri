...
$.listdata = function (url, config) {
  var listid = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'listitem';
...
function linkpaginate() {
  $('[data-paginate-link]').click(function (e) {
    e.preventDefault();
    var href = $(this).attr('href').replace(urlbase(), '');
    var splitHref = href.split('?');
    var url = splitHref[0];
    var config = $.getParamsUrl(href);
    $.listdata(url, config);
  });
}
...
__webpack_require__(/*! /home/anonymouse/Public/laravel/qodr-smd/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/anonymouse/Public/laravel/qodr-smd/resources/sass/app.scss */"./resources/sass/app.scss");
